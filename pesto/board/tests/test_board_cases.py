...
_TestBoardToFenCase = tuple[Board, str]


class TestBoardToFenCases:
    def case_starting_position(self) -> _TestBoardToFenCase:
        board = Board.new()
        fen = "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"
        return board, fen

    def case_caro_kann_fantasy(self) -> _TestBoardToFenCase:
        board = Board(
            ply=6,
            halfmove_clock=0,
            to_move=Color.BLACK,
    ...
    def case_deep_blue_kasparov_1997_game_6(self) -> _TestBoardToFenCase:
        board = Board(
            ply=38,
            halfmove_clock=0,
            to_move=Color.BLACK,
    ...
    def case_carlsen_nepo_2021_game_6(self) -> _TestBoardToFenCase:
        board = Board(
            ply=272,
            halfmove_clock=2,
            to_move=Color.BLACK,
